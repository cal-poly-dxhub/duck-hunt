...
```bash
PHOTO_BUCKET=photo-bucket-dev-sshreyy AWS_REGION=us-west-2 python3 make_collages.py
```
...
python3 make_collages.py --bucket photo-bucket-dev-sshreyy --team <team_id>

# First N teams only:
python3 make_collages.py --bucket photo-bucket-dev-sshreyy --limit 3
```
